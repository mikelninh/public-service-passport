...
test('v1 public page identifies itself as a bounded Public Pilot', () => {
  assert.ok(html.includes('v1.0 · Public Pilot'));
...
test('v1 has no consequential authority tool or submission identifier', () => {
  assert.equal(/submit_application|sign_application|authenticate_as_user|upload_to_authority/.test(js), false);
